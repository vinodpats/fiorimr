		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori application using Managed Router",
									"targetURL": "#comaccenturefioriui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaccenturefioriui-display": {
								"semanticObject": "comaccenturefioriui",
								"action": "display",
								"description": "Fiori app using managed router",
								"title": "Fiori application using Managed Router",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.accenture.fioriui",
									"url": sap.ui.require.toUrl("com/accenture/fioriui")
								}
							}
						}
					}
